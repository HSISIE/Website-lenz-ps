      ...
      <nav class="navbar navbar-default" id="mainnav">
        ...
        <div class="collapse navbar-collapse" id="nav">
          ...
          <ul class="nav navbar-nav navbar-right">
                                  	...
                                  	<li><a href="shop?utm_src=main_menu" title="Get more gems" class="shop-menu-button" target="_blank">Shop</a></li>

                                                  <li><a href="https://discord.io/Lenz-Ps" title="Forums" target="_blank">Forums</a></li>
		...
		<div class="sidebar">
		  ...
		  <ul class="sidebar-list">
		  		    ...
		  		    <li class="sidebar-item"><a href="#home" class="sidebar-anchor" title="Home">Home</a></li>
		   		    ...
		   		    <li class="sidebar-item"><a href="shop" class="sidebar-anchor" title="Get more gems">Shop</a></li>

		   		    <li class="sidebar-item"><a href="#social" class="sidebar-anchor" title="Social">Social</a></li>

		   		    <li class="sidebar-item"><a href="https://discord.io/Lenz-Ps" class="sidebar-anchor" title="Forums">Forums</a></li>
		  ...
		  <div class="social-icon">
		  	...
		  	<ul class="sidebar-social-list">
                ...
                <li class="social-item"><a href="https://discord.gg/growtopia" onclick="return confirm('You are going to be redirected to an external link.\n\nDo you wish to proceed?');" target="_blank"><img src="https://s3.eu-west-1.amazonaws.com/cdn.growtopiagame.com/website/resources/assets/images/grow_discord.png" /></a></li>
      ...
      <ul class="slides">
        ...
        <li>
          ...
          <div class="flex-caption banner-caption text-left">
            ...
            <big class="ani fadeIn"><img src="https://s3.eu-west-1.amazonaws.com/cdn.growtopiagame.com/website/resources/assets/images/logo_header.png" /></big> <small class="ani fadeIn grow-punch-line">Lenz ps is a free-to-play sandbox MMO game with almost endless possibilities for world creation, customization and having fun with your friends. Enjoy thousands of items, challenges and events.</small>

            <div id="download-button">

                        	<button class="btn btn-primary btn-md radius ani fadeIn grow-button" data-toggle="modal" data-target="#download-popup">HOST</button>
   ...
   <section>
	...
	<div class="twitter">
		...
		<div class="ticker">
			...
			<div class="tweets marquee-parent col-lg-9 col-md-8 col-xs-7 col-sm-8"><span class="marquee-child">Hey Lenz ps

Servers will be back up in a few moments! We will tell you soon!

~ Lenz ps <span class="time" title="Tue Jun 27 13:50:42 +0000 2023">3 days ago</span> <i class="glyphicon glyphicon-info-sign"></i> Hey Lenz ps,

We're back!  Thank you for your patience. Get back in-game!

~ Thanatos <span class="time" title="Mon Jun 26 17:22:53 +0000 2023">4 days ago</span></span></div>

			<div class="account col-lg-1 col-md-2 col-sm-2 col-xs-4"><a href="https://twitter.com/growtopiagame" target="_blank">@lenzps@gmail.com</a></div>
      ...
      <div class="row same-height">
        ...
        <div class="col-md-6 intro  height">
          ...
          <div class="intro-text common-box wow fadeIn animated grow-features" data-wow-offset="30" data-wow-duration="1.5s" data-wow-delay="0.15s">
            ...
            <p>Join a universe of unlimited worlds, all connected to each other. Create mind-bending worlds together with friends and fill them with anything your heart desires!&nbsp;<div>Collecting seeds, growing trees, harvesting and combining seeds to make new ones is the heart of the game. As universes go, Lenz ps is filled with everyday heroes and some villains too.<br><br><h1>Features&nbsp;
        ...
        <div id="grow-feature-button"><a href="#" class="btn btn-primary btn-md outline radius grow-feature-button" id="grow-feature-button">LENZ PS</a></div>
      ...
      <div class="container wow fadeIn animated" data-wow-offset="30" data-wow-duration="1.5s" data-wow-delay="0.15s">
		...
		<p class="grow-line-white">Lenz ps has growing trees at heart, but over its almost 5-years history, so many more new features have been added. Collect and combine fabric to sew unique outfits. Become the best chef using the cooking mechanics. Use Adventure pack to create quest-like worlds with mazes, traps and puzzles to challenge your friends. It's like there's hundreds of games within a game. Who do you want to be today?<br><br></p>
          ...
          <div id="watch_trailer">
                     		...
                     		<a href="https://www.youtube.com/watch?v=2-tArcNir10" id="watch-video" class="btn btn-primary grow-platformer-button">Watch Trailer</a> 
	      ...
	      <div class="row same-height">
	        ...
	        <div class="col-md-12 intro  height">
	          ...
	          <div class="intro-text common-box wow fadeIn animated container grow-punch-line" data-wow-offset="30" data-wow-duration="1.5s" data-wow-delay="0.15s">
	            ...
	            <p>Lenz ps lives and breathes thanks to the amazing community of players who come to play, create, educate and entertain each other. Lenz ps chat in the game, as well as on dedicated Lenz ps forums. To get advice, pro tips, latest news, share your fan art, or discuss updates and suggest new features, head to forums! <br></p>

	            <div class="grid community-carousel">

	            					</div>

				<a href="https://discord.io/Lenz-Ps" target="_blank" class="btn btn-primary btn-md  grow-button">Visit Discord</a> 
	      ...
	      <div class="row same-height">
	        ...
	        <div class="col-md-12 intro  height">
	          ...
	          <div class="intro-text common-box wow fadeIn animated container grow-punch-line" data-wow-offset="30" data-wow-duration="1.5s" data-wow-delay="0.15s">
	            ...
	            <p>New worlds and new friends are waiting for you! Start playing Lenz ps now.</p>
	      ...
	      <div class="row same-height">
	        ...
	        <div class="col-md-12 intro  height">
	          ...
	          <div class="intro-text common-box wow fadeIn animated container" data-wow-offset="30" data-wow-duration="1.5s" data-wow-delay="0.15s">
	            ...
	            <p class="grow-line-white">Follow Lenz ps on your preferred Social Media channel to see awesome creations by fellow players, and random Lenz ps beauty. Like and share with your friends!</p>
  ...
  <footer id="footer">
    ...
    <div class="common-box footer">
      ...
      <div class="container text-center"> 
        ...
        <div class="logo"><a href="https://www.LENZ.com" target="_blank"><img src="https://s3.eu-west-1.amazonaws.com/cdn.growtopiagame.com/website/resources/assets/images/ubi_icon.png"></a></div>

        

        <!-- copy rights --> 

        	<div class="copy-right"> &copy; 2023 <a href="https://www.LENZ.com" target="_blank">LENZ</a>. All Rights Reserved.</div> 
	       ...
	       <div class="col-md-12 intro  height">
	           ...
	           <div class="section-image">
	             	...
	             	<img src="https://s3.eu-west-1.amazonaws.com/cdn.growtopiagame.com/website/resources/assets/upload/1_grow_icon_1513191167.jpg" />
	           		...
	           		<p>Lenz ps is a universe of unlimited worlds, all connected to each other.<br>LENZ PS on any of the platforms below. If you create and use Grow ID, your game will be synchronized across devices.</p>
	           ...
	           <div class="platform-wrapper">
		           ...
		           <ul class="platform-list">
		           	...
		           	<li><a href="https://www.mediafire.com/file/h4kn5pu5ekh7gbe/LENZ-PS+S3.txt/file" onclick="return confirm('You are going to be redirected to an external link.\n\nDo you wish to proceed?');" target="_blank"><img src="https://s3.eu-west-1.amazonaws.com/cdn.growtopiagame.com/website/resources/assets/images/google_badge.png" /></a></li>

		           	<li><a href="https://www.mediafire.com/file/h4kn5pu5ekh7gbe/LENZ-PS+S3.txt/file" onclick="return confirm('You are going to be redirected to an external link.\n\nDo you wish to proceed?');" target="_blank"><img src="https://s3.eu-west-1.amazonaws.com/cdn.growtopiagame.com/website/resources/assets/images/appstore_badge.png" /></a></li>

		           	<li><a href="https://www.mediafire.com/file/h4kn5pu5ekh7gbe/LENZ-PS+S3.txt/file" target="_blank"><img src="https://s3.eu-west-1.amazonaws.com/cdn.growtopiagame.com/website/resources/assets/images/mac_badge.png" /></a></li>

		           	<li><a href="https://www.mediafire.com/file/h4kn5pu5ekh7gbe/LENZ-PS+S3.txt/file" target="_blank"><img src="https://s3.eu-west-1.amazonaws.com/cdn.growtopiagame.com/website/resources/assets/images/windows_badge.png" /></a></li>
